...
"use strict";
module.exports = __webpack_require__.p + "92e734471aa64f984ee3.js";
...
function _callApi() {
  _callApi = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2() {
    var data;
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
          ...
          return Excel.run( /*#__PURE__*/function () {
            var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(context) {
              var sheet, range, i, j, cellAddress, response;
              return _regeneratorRuntime().wrap(function _callee$(_context) {
                while (1) switch (_context.prev = _context.next) {
                  case 0:
                    sheet = context.workbook.worksheets.getActiveWorksheet();
                    range = sheet.getRange("A1:C4").load("values");
                    _context.next = 4;
                    return context.sync();
                  case 4:
        ...
        case 6:
          ...
          document.getElementById("result").innerText = "Error: ".concat(_context2.t0.message, ", data = ").concat(JSON.stringify(data));
        case 10:
        case "end":
...
function _validateData() {
  _validateData = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee4() {
    var data;
    return _regeneratorRuntime().wrap(function _callee4$(_context4) {
      while (1) switch (_context4.prev = _context4.next) {
        case 0:
          ...
          return Excel.run( /*#__PURE__*/function () {
            var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3(context) {
              var sheet, range, i, j, cellAddress, response, result, _i, _Object$entries, _Object$entries$_i, cell, status, cellRange;
                ...
                while (1) switch (_context3.prev = _context3.next) {
                  ...
                  case 10:
                    ...
                    for (_i = 0, _Object$entries = Object.entries(result); _i < _Object$entries.length; _i++) {
                      _Object$entries$_i = _slicedToArray(_Object$entries[_i], 2), cell = _Object$entries$_i[0], status = _Object$entries$_i[1];
                      cellRange = sheet.getRange(cell);
                      if (status === "Error") {
        ...
        case 6:
          ...
          document.getElementById("result").innerText = "Error: ".concat(_context4.t0.message, ", data = ").concat(JSON.stringify(data));
        case 10:
        case "end":
...
// Module
var code = "<!DOCTYPE html>\n<html>\n\n<head>\n    <meta charset=\"UTF-8\" />\n    <meta http-equiv=\"X-UA-Compatible\" content=\"IE=Edge\" />\n    <meta name=\"viewport\" content=\"width=device-width, initial-scale=1\">\n    <title>UBS Fundamentals</title>\n\n    <!-- Office JavaScript API -->\n    <" + "script type=\"text/javascript\" src=\"https://appsforoffice.microsoft.com/lib/1.1/hosted/office.js\"><" + "/script>\n\n    <!-- Fluent UI styles (if you need them for styling) -->\n    <link rel=\"stylesheet\" href=\"https://static2.sharepointonline.com/files/fabric/office-ui-fabric-core/11.0.0/css/fabric.min.css\"/>\n\n    <!-- Custom styles -->\n    <link href=\"" + ___HTML_LOADER_IMPORT_0___ + "\" rel=\"stylesheet\" type=\"text/css\" />\n</head>\n\n<body class=\"ms-Fabric\">\n    <header class=\"ms-bgColor-neutralLighter ms-font-m ms-fontColor-neutralPrimary\">\n        <!--<img src=\"ubs.png\"/>-->\n        <h1 class=\"ms-font-l\">UBS Fundamentals Model Upload</h1>\n    </header>\n    \n    <main id=\"app-body\" class=\"ms-welcome__main\">\n        <div id=\"mainContent\">\n            <p class=\"ms-font-m\">Click the button below to upload data from cells A1 to C4:</p>\n            \n            <!-- Upload Model Button -->\n            <button id=\"apiCallButton\" class=\"ms-Button ms-Button--primary\">\n                <span class=\"ms-Button-label\">Upload Model</span>\n            </button>\n\n            <!-- Validate Data Button -->\n            <button id=\"validateButton\" class=\"ms-Button ms-Button--secondary\">\n                <span class=\"ms-Button-label\">Validate Data</span>\n            </button>\n\n            <!-- Start Wizard Button -->\n            <button id=\"startWizardButton\" class=\"ms-Button ms-Button--third\">\n                <span class=\"ms-Button-label\">Start Wizard Test</span>\n            </button>\n\n            <!-- Display the result from the API call -->\n            <p id=\"result\" class=\"ms-font-m\"></p>\n        </div>\n\n        <!-- Wizard Content will be dynamically inserted here -->\n        <div id=\"wizardContent\" style=\"display: none;\">\n            <h1 class=\"ms-font-l\">Upload Flow Step 1</h1>\n            <p class=\"ms-font-m\">This is the first step in the upload flow.</p>\n            \n            <!-- Back Button -->\n            <button id=\"backButton\" class=\"ms-Button ms-Button--primary\">\n                <span class=\"ms-Button-label\">Back</span>\n            </button>\n        </div>\n    </main>\n\n    <!-- Task pane script -->\n    <" + "script src=\"" + ___HTML_LOADER_IMPORT_1___ + "\"><" + "/script>\n</body>\n\n</html>\n";
// Exports
