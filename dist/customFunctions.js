 ...
 * @customfunction
 */
function wire(_x, _x2) {
  return _wire.apply(this, arguments);
}
function _wire() {
  _wire = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(text, number) {
